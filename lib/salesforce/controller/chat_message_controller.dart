...
//     request.fields['businessnumber'] = busNum;
//     request.fields['userWhatsAppNumber'] = fullNum;
//     request.fields['messageBody'] = msg;

//     // check if image/video/doc/audio is selected
//     if (selectedFile != null) {
//       request.files.add(await http.MultipartFile.fromPath(
//         'file', // backend expects this key
//         selectedFile!.path,
//       ));
//     }
...
//       debug("setSelectedFile CALLED with: $fil");
//     selectedFile = fil;
//     if (fil == null) {
//       isImage = false;
//       isVideo = false;
...
class ChatMessageController extends ChangeNotifier {
  ...
  Future<void> messageHistoryApiCall({
    ...
    debug("response response ${jsonDecode(response!.body)}");
    if (response != null && response.statusCode == 200) {
      final List<dynamic> data = jsonDecode(response.body);
      chatHistoryList
        ..clear()

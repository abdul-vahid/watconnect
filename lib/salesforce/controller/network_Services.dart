  ...
  static Future<http.Response?> makeRequest({
    ...
    try {
      ...
      switch (response.statusCode) {
        ...
        case 400:
          log("\x1B[95mFCM  =====================================================================================================================================================================================================================");
          log("\x1B[95mFCM  ⚠️ api with status as 400 : ${method}  \nApiurl  ${url}  \nBody  ${body}\nstatus code    ${response.statusCode}\n  body ${response.body}  ");
          log(" \x1B[95mFCM  =====================================================================================================================================================================================================================");
        ...
        case 500:
          log("\x1B[95mFCM   =====================================================================================================================================================================================================================");
          log("\x1B[95mFCM  ⚠️ Server error :${method}   ${url}  ${body}    ${response.statusCode}]: ${response.body}  ");
          log("\x1B[95mFCM  ====================================================================================================================================================================================================================="); // EasyLoading.showToast("Something went wrong: ${response.body}");
          break;

        default:
          log(" \x1B[95mFCM  =====================================================================================================================================================================================================================");
          log(" \x1B[95mFCM  Unhandled status [  ${url}  ${body}    ${response.statusCode}]: ${response.body}");
          log(" \x1B[95mFCM  =====================================================================================================================================================================================================================");
          break;
      }
    } catch (e) {

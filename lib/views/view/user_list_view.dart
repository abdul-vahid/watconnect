...
//   List<UserDataModel> usermodel = [];
//   // final usermodell = [usermodel]; // Wrap single object in a list
...
//       UserDataModel user = viewModel.model;
//       alldata.add(user);
//       print("Alldata: ${user.username}");
//     }

//     userlistvm = alldata.where((user) {
...
//                         setState(() {
//                           // selectedPaymentTerm = selectedValue;
//                         });
//                       },
//                       isExpanded: true,

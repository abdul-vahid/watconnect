...
class _MyAppState extends State<MyApp> {
  ...
  String _extractLeadPhoneFromUrl(String url) {
    try {
      ...
      try {
        ...
        // Check for pattern: /Lead/chat/91740989118
        // Segments would be: ["Lead", "chat", "91740989118"]
        if (segments.length >= 3) {
          // The phone number should be the last segment after "chat"
  ...
  bool _isPhoneMatch(String recordPhone, String searchPhone) {
    ...
    // Check last 10 digits (for Indian numbers)
  ...
  /// 🔹 Navigate to appropriate chat screen based on object type
